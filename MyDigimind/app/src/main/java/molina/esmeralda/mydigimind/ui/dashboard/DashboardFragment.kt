...
import molina.esmeralda.mydigimind.ui.home.HomeFragment
...
class DashboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val et_titulo = root.findViewById(R.id.titulo) as EditText
        ...
        btn_save.setOnClickListener{
            ...
            var tarea = Recordatorio(titulo, dias.toString() ,tiempo)
